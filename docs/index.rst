...
.. |tutorial| raw:: html
   ...
   <a href="https://cloud.google.com/community/tutorials/cloud-iot-fledge">Using Fledge with IoT Core on Google Cloud</a>
...
The *fledge-north-gcp* plugin provide connectivity from a Fledge system to the Google Cloud Platform. The plugin connects to the IoT Core in Google Cloud using MQTT and is fully compliant with the security features of the Google Cloud Platform. See |tutorial| for a tutorial on setting up a Fledge system and getting it to send data to Google Cloud.
